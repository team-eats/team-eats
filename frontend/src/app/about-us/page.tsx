...
export default function() {
    return (
     ...
     <div className={"container mx-auto border-4 border-black px-10 py-14 mt-20"}>
                  ...
                  <p>Normally, both your asses would be dead as ducking fried chicken, but you happen to pull this
