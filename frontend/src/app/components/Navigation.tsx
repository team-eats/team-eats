    ...
    return (
        ...
        <>
            ...
            <Navbar fluid rounded>
                <Navbar.Brand href="/" className="flex flex-wrap justify-between items-center">
                    ...
                    <form className="flex items-center max-w-sm py-4 px-8">
                        ...
                        <div className="relative">
                            ...
                            <input type="text" id="simple-search"
                                   className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg hover:border-red-800 focus:ring-red-800 focus:border-red-800 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500 px-16"
